...
void main() {
  ...
  setUp(() async {
    ...
    await fixture.customStatement('PRAGMA user_version = 2');
    await fixture.close();
  });
  ...
  test('v2 migration preserves manual rows and defaults photo metadata',
      () async {
    database = GymDatabase(NativeDatabase(databaseFile, logStatements: false));
